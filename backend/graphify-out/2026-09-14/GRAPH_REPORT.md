...
## Corpus Check
- 62 files · ~29,361 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 586 nodes · 810 edges · 49 communities (26 shown, 21 thin omitted)
...
### Community 12 - "StartupInfoListener"
Cohesion: 0.10
Nodes (22): org.junit.jupiter.api.DisplayName, org.junit.jupiter.api.Test, org.slf4j.Logger, org.springframework.boot.context.event.ApplicationReadyEvent, org.springframework.boot.test.context.SpringBootTest, org.springframework.context.annotation.Configuration, org.springframework.context.ApplicationContext, org.springframework.context.ApplicationListener (+14 more)
...
### Community 37 - "org.springframework.data.jpa.repository.JpaRepository"
Cohesion: 0.27
...
### Community 40 - "ImageReferencesValidator"
Cohesion: 0.29
...
## Knowledge Gaps
- **131 isolated node(s):** `TODO`, `IN_PROGRESS`, `COMPLETED`, `1. Overview & Domain Architecture`, `2.1 AcademicEvent Schema Overview` (+126 more)
...
- **Why does `Note` connect `Note` to `AcademicContext`, `AcademicEvent`, `Course`, `jakarta.persistence.Entity`, `Task`, `org.springframework.data.jpa.repository.JpaRepository`, `NoteContent`, `ImageMetadata`?**
  _High betweenness centrality (0.164) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `Note`, `Course`, `jakarta.persistence.Entity`, `TaskStatus`, `org.springframework.data.jpa.repository.JpaRepository`?**
